    ...
    return (
        <div className="w-full mx-auto mt-[clamp(72px,8vw,105px)] flex flex-col relative overflow-hidden bg-white page-enter">
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 mt-4 w-full max-w-[540px]">
                    <WhatsAppButton className="w-full sm:w-auto justify-center pl-6 pr-1 py-1" />
                    <button
                        type="button"
                        onClick={() => {
                            setPage('contact');
                        ...
                        className="w-full sm:w-auto flex items-center justify-center gap-2 pl-6 pr-1 py-1 rounded-full bg-[#0d2446] cursor-pointer hover:scale-105 transition-transform no-underline border-0 shadow-lg hover:shadow-xl"
